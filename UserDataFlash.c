...
8. Filename	        : UserQueue.c
9. Version	        : 1.0
10. CreatedDate     : 2017/03/30
11. ModifiedDate	: 
12. License	        : Heumtech
13. MCU Type	    :
14. Clock Frequency : 
...
// output: none
//============================================================================
void DataFlash_Erase(uint16_t   u16Addr){
        IAPAL = u16Addr;
		IAPAH = u16Addr>>8;
		IAPFD = 0xFF;
	  	set_IAPEN; 
...
// output: none
//============================================================================
void Set_Dust_Data(UINT16 u16_addr,UINT8 u8_data){
    Write_Dataflash_Byte(u16_addr,u8_data);
}
...
// output: none
//============================================================================
void Get_Dust_Cal_Data(uint16_t *u16Buff, uint8_t u8DataType){
    if (u8DataType==0) {
        *u16Buff = (read_APROM_BYTE(FLASH_CALIBRATION_L_HIGH)<<8) + read_APROM_BYTE(FLASH_CALIBRATION_L_LOW);
    }else if (u8DataType==1){
        *u16Buff = (read_APROM_BYTE(FLASH_CALIBRATION_H_HIGH)<<8) + read_APROM_BYTE(FLASH_CALIBRATION_H_LOW);
    }
...
// output: none
//============================================================================
// void DataFlash_WriteByte(uint16_t   u16Addr){
//     //Save changed RAM data to APROM DATAFLASH
//     u8_addrl_r = u16_addr;
//     if (u8_addrl_r<0x80){
//         u8_addrl_r =0;
